...
namespace MyRPGConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.SetBufferSize(96, 31);
            Console.SetWindowSize(96, 31);
           ...
           Console.WriteLine(@"█                                           |/         \\                                      █");
            ...
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                       -->| GUIA DE ESTABILIDADE E FUNCIONAMENTO |<--                         █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬█");
            Console.WriteLine("█                                                                                              █");
            ...
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                    O programa é executado em uma tela de prompt, é ideal                     █");
            Console.WriteLine("█                                que seja feita algumas muandaças.                             █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                     Não clicar na tela e respeitar a margem é obrigatório                    █");
            Console.WriteLine("█                        para o bom funcionamento da tarefa e execução.                        █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                           O programa funciona APENAS em Windows                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                     As ações são efetivadas baseado no que é digitado e                      █");
            Console.WriteLine("█                      enviado, maioria das mesmas são identificadas pelo                      █");
            Console.WriteLine("█                      primeiro caractere e selecionado entre parênteses.                      █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█     > Assim que você estiver conscientizado, pressione qualquer tecla para começar           █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█                                                                                              █");
            Console.WriteLine("█▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬█");
            Console.ReadKey();
            ...
            Console.WriteLine("█▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬█");
            Console.WriteLine("█     █                                                                                  █     █");
           Console.WriteLine(@"█     █      |  _ \|  _ \ / ___|  _ __   ___    / ___|___  _ __  ___  ___ | | ___        █     █");
            Thread.Sleep(500);                                                                                          
           Console.WriteLine(@"█     █      | |_) | |_) | |  _  | '_ \ / _ \  | |   / _ \| '_ \/ __|/ _ \| |/ _ \       █     █");
            Thread.Sleep(500);                                                                                          
           Console.WriteLine(@"█     █      |  _ <|  __/| |_| | | | | | (_) | | |__| (_) | | | \__ \ (_) | |  __/       █     █");
            Thread.Sleep(500);                                                                                          
           Console.WriteLine(@"█     █      |_| \_\_|    \____| |_| |_|\___/   \____\___/|_| |_|___/\___/|_|\___|       █     █");
            Thread.Sleep(500);                                                                                          
            Console.WriteLine("█     █                                                                                  █     █");
            Console.WriteLine("█▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬█");
            Console.WriteLine("█                                                                                              █");
